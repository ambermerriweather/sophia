...
export interface Activity {
  ...
  displayType?: 'story-time' | 'word-detective' | 'sentence-builder' | 'number-ninja' | 'measurement-master' | 'data-detective' | 'science-explorer' | 'life-cycles-lab' | 'sink-or-swim' | 'community-quest' | 'leaders-and-citizens' | 'emotions-and-collaboration' | 'planning-and-organization' | 'working-memory-game' | 'sink-or-swim-mission'; // To specify custom renderers
